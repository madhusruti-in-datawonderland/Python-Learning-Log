...
After assigning value to each variable.
Using: 
print("Addition of the two numbers is", m+n)
print("Substraction of the two numbers is", x-y)
print("Multiplication of the two numbers is", p*q)
print("Division of the two numbers is", j/k)
To get the desired outcomes from the basic four arithmetic operators.
...
Using: int(input("Enter a number"))
